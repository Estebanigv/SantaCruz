...
export default function NosotrosPage() {
  ...
  const tasks = [
    ...
    { name: 'Historia completa de la viña', status: 'pending' },
    { name: 'Fotografías del equipo', status: 'pending' },
    { name: 'Filosofía y valores', status: 'pending' },
    { name: 'Información de sustentabilidad', status: 'pending' },
    { name: 'Timeline histórico', status: 'pending' },
    { name: 'Certificaciones y premios', status: 'pending' },
  ]
        ...
        <div className="flex justify-center mb-10">
          <div className="relative w-40 h-40">
            ...
            <svg className="w-full h-full transform -rotate-90">
              ...
              />
              <defs>
                <linearGradient id="gradient-nos" x1="0%" y1="0%" x2="100%" y2="0%">
