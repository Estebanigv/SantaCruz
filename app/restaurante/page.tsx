...
export default function RestaurantePage() {
  ...
  const tasks = [
    { name: 'Sección en página principal', status: 'done' },
    { name: 'Información de contacto', status: 'done' },
    { name: 'Horarios y disponibilidad', status: 'done' },
    { name: 'Carta digital completa', status: 'pending' },
    { name: 'Fotografías de platos', status: 'pending' },
    { name: 'Precios del menú', status: 'pending' },
    { name: 'Sistema de reservas online', status: 'pending' },
    { name: 'Sección de eventos privados', status: 'pending' },
  ]
        ...
        <div className="flex justify-center mb-10">
          <div className="relative w-40 h-40">
            ...
            <svg className="w-full h-full transform -rotate-90">
              ...
              />
              <defs>
                <linearGradient id="gradient-rest" x1="0%" y1="0%" x2="100%" y2="0%">
