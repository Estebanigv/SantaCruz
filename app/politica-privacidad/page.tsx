          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-6 text-gray-700 space-y-2">
                ...
                <li>Reserva una mesa en nuestro restaurante</li>
            ...
            <section className="mb-12">
              ...
              <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                <li>
                  <strong>Redes Sociales:</strong> Instagram, Facebook, LinkedIn, YouTube, X (Twitter)
                </li>
                <li>
                  <strong>TripAdvisor:</strong> Para mostrar reseñas y calificaciones de visitantes
                </li>
                <li>
                  <strong>Servicios de análisis:</strong> Para comprender el comportamiento de los usuarios
                </li>
              </ul>
            </section>
