...
export const featuredWines: Wine[] = [
  ...
  },
  {
    id: '2',
    sku: 'VSC-ICO-002',
    name: 'Icono Santa Cruz – Terrazas',
    varietal: 'Petit Verdot',
    category: 'tinto',
    vintage: 2020,
    price: 35990,
    image: '/images/SANTA-CRUZ-PETIT-VERDOT.png',
    grayBg: '/images/Gris Fondo.png',
    colorBg: '/images/Color fondo.png',
    rating: 5,
    badge: 'icono',
    description: 'Vino ícono de la viña, Petit Verdot de terrazas excepcionales.',
  },
  {
    id: '3',
    sku: 'VSC-SYR-003',
