      ...
      <div className="relative container-custom py-20 md:py-28">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 mb-20 pb-16 border-b border-gray-800/50">
          ...
          <div>
            ...
            <p className="text-gray-400 text-base leading-relaxed mb-10 max-w-md" style={{ lineHeight: '1.8' }}>
            ...
            <div className="space-y-3 mb-10">
              <div className="flex items-start gap-3 text-sm text-gray-400">
                ...
                <a href="mailto:ventas@vinasantacruz.cl" className="hover:text-gold-500 transition-colors">
              ...
              <div className="flex items-start gap-3 text-sm text-gray-400">
                ...
                <div className="flex flex-col gap-1">
                  <span className="hover:text-gold-500 transition-colors">Ventas: +56 9 2884 2042</span>
                  <span className="hover:text-gold-500 transition-colors">Tours: +56 9 7218 8755</span>
                </div>
              </div>
            </div>
            ...
            <div className="mb-8">
              <p className="text-xs text-gray-500 uppercase tracking-[0.2em] mb-5 font-semibold">Síguenos</p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-12 lg:gap-8 mb-16">
          {/* Products */}
          <div>
            <h4 className="font-semibold text-sm mb-6 text-gold-500 uppercase tracking-[0.15em]">Productos</h4>
          ...
          {/* Experiences */}
          <div>
            <h4 className="font-semibold text-sm mb-6 text-gold-500 uppercase tracking-[0.15em]">Experiencias</h4>
            <ul className="space-y-3">
          ...
          {/* Club */}
          <div>
            <h4 className="font-semibold text-sm mb-6 text-gold-500 uppercase tracking-[0.15em]">Club</h4>
            <ul className="space-y-3">
          ...
          {/* About */}
          <div>
            <h4 className="font-semibold text-sm mb-6 text-gold-500 uppercase tracking-[0.15em]">Nosotros</h4>
            <ul className="space-y-3">
          ...
          {/* Help */}
          <div>
            <h4 className="font-semibold text-sm mb-6 text-gold-500 uppercase tracking-[0.15em]">Ayuda</h4>
            <ul className="space-y-3">
