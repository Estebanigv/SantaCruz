    ...
    >
      <div className="relative">
        ...
        <div className="relative w-16 h-16 rounded-full bg-[#25D366] flex items-center justify-center shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-110">
          {/* WhatsApp Icon */}
          <svg className="w-8 h-8 text-white transition-transform duration-500 group-hover:rotate-12" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Elegant glow effect */}
          <div className={`absolute inset-0 rounded-full bg-gold-500 blur-2xl transition-opacity duration-500 -z-10 ${
            isHovered ? 'opacity-30' : 'opacity-0'
          }`} />
        </div>

        {/* Tooltip - Refined and formal */}
        <div className={`absolute right-full mr-5 top-1/2 -translate-y-1/2 transition-all duration-300 ${
