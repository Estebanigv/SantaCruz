  ...
  return (
    <section className="bg-gradient-to-b from-cream-50 to-white section-padding">
      <div className="container-custom">
        <SectionHeader label="Testimonios" title="Lo Que Dicen Nuestros Clientes" />
          ...
          {testimonials.map((testimonial) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="font-[family-name:var(--font-raleway)] text-xs text-gray-500 uppercase tracking-[0.15em] font-medium">
                  Reseña de Google
                </span>
              </div>
              ...
              {/* Quote Text */}
              <p
                className="font-[family-name:var(--font-raleway)] text-base text-gray-700 leading-relaxed mb-8 font-light line-clamp-6"
