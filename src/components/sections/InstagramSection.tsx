        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
          {socialLinks.map((social) => (
            ...
            >
              ...
              <div className="flex justify-center mb-6 text-gray-700 transition-all duration-300 relative z-10"
                style={{
                  color: (cardFillProgress[social.name] || 0) > 30 ? 'white' : '',
                  transform: social.name === 'Instagram'
                  ...
                  filter: (cardFillProgress[social.name] || 0) > 30
              ...
              {/* Network Name */}
              <h3 className="font-[family-name:var(--font-raleway)] text-xl font-light text-center mb-3 text-black-900 tracking-wide transition-colors duration-500 relative z-10"
                style={{
              ...
              {/* Username */}
              <p className="font-[family-name:var(--font-raleway)] text-sm text-center text-gray-500 font-light transition-colors duration-500 relative z-10"
                style={{
                  color: (cardFillProgress[social.name] || 0) > 50 ? 'rgba(255, 255, 255, 0.9)' : ''
                }}
              >
                {social.username}
              </p>
              ...
              {/* Follow indicator */}
              <div className="flex items-center justify-center gap-2 mt-6 transition-opacity duration-500 relative z-10"
                style={{
              ...
              >
                ...
                <svg className="w-4 h-4 text-white transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}
                  style={{
