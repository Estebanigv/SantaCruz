        ...
        {!isSubmitted ? (
          <>
            ...
            <p className="text-sm text-white/80 max-w-[480px] mx-auto leading-relaxed">
              Al suscribirte aceptas recibir comunicaciones de Viña Santa Cruz. Puedes cancelar tu suscripción en cualquier momento.{' '}
              <a href="/privacidad" className="text-gold-400 underline hover:text-gold-300 transition-colors">
