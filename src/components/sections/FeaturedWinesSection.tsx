...
function WineCardExpanded({
  ...
  return (
    <div ref={contentRef} className="flex flex-col md:flex-row h-full overflow-hidden" style={{ opacity: isVisible ? 1 : 0 }}>
      ...
      <div className="h-[38%] md:h-full md:w-[42%] relative flex items-center justify-center flex-shrink-0">
        ...
        <img
          ...
          loading="eager"
          decoding="async"
          className="relative z-10 h-[90%] md:h-[85%] w-auto object-contain max-h-[220px] md:max-h-none"
