...
function WineCardExpanded({
  ...
  return (
    <div ref={contentRef} className="flex flex-col md:flex-row h-full overflow-hidden" style={{ opacity: isVisible ? 1 : 0 }}>
      {/* Top/Left - Bottle with background - reducido en móvil para que quepa el contenido */}
      <div className="h-[32%] md:h-full md:w-[42%] relative flex items-center justify-center flex-shrink-0">
        ...
        {/* Wine bottle - ajustado para móvil */}
        <img
          src={wine.image}
          alt={wine.name}
          loading="eager"
          decoding="async"
          className="relative z-10 h-[88%] md:h-[85%] w-auto object-contain max-h-[170px] md:max-h-none"
      ...
      <div className="flex-1 md:w-[58%] p-3 md:p-4 lg:p-5 flex flex-col relative bg-white overflow-y-auto">
        ...
        <div className="mb-3 md:mb-4 pr-16 md:pr-24">
          <p className="text-gold-600 text-[10px] md:text-xs font-semibold uppercase tracking-wider mb-1">
            {wine.varietal}
          </p>
        ...
        <div className="mb-4 md:mb-7">
          <p className="text-gray-600 text-[11px] md:text-sm leading-relaxed line-clamp-3 md:line-clamp-none">
            {wine.description || 'Descripción no disponible.'}
          </p>
        </div>

        {/* Characteristics */}
        <div className="grid grid-cols-2 gap-1.5 md:gap-2 mb-4 md:mb-5">
        ...
        <div className="pt-3 md:pt-4 mt-auto border-t border-gray-100">
          ...
          <div className="mb-2 md:mb-3">
            ...
            <span className="text-gray-400 text-[10px] md:text-sm ml-1 md:ml-2">CLP</span>
          </div>
          ...
          <div className="flex flex-row gap-2">
            ...
            <button
              onClick={onAddToCart}
              className="group/btn btn-shimmer btn-ripple relative flex-1 flex items-center justify-center gap-1.5 sm:gap-2 bg-gradient-to-r from-gold-600 via-gold-500 to-gold-600 bg-[length:200%_100%] text-white text-[11px] sm:text-sm font-medium py-2 sm:py-2.5 px-2.5 sm:px-4 rounded-lg overflow-hidden transition-all duration-300 ease-out shadow-lg hover:shadow-2xl hover:shadow-gold-500/40 hover:scale-[1.02] hover:bg-right active:scale-[0.98]"
            >
            ...
            <button
              ...
              disabled
              className="group/dl flex items-center justify-center gap-1 sm:gap-2 py-2 sm:py-2.5 px-2 sm:px-4 border border-gray-200 text-gray-400 rounded-lg text-[11px] sm:text-sm font-medium cursor-not-allowed opacity-50 whitespace-nowrap"
            >
              <Download
